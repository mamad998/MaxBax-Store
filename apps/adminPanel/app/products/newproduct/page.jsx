        ...
        <form
          ...
          <div className=" border-b border-gray-400 col-span-2 m-3">
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                href={`/products`}>
                <button className="text-center cursor-pointer text-sky-300 hover:text-sky-400 ms-auto">
          ...
          <label
            ...
            <input
              ...
              id="special"
            />
            <div className="w-6 h-6 mx-3 border-2 border-gray-400 rounded-md peer-checked:bg-blue-500 peer-checked:border-blue-500  group-hover:border-blue-400 transition-all flex items-center justify-center">
              <svg
          ...
          <div className="col-span-1 flex justify-start items-center ms-auto py-1 mx-3">
            ...
            <button
              ...
              className="py-0.5 px-2 bg-sky-300 hover:bg-sky-400 duration-300 cursor-pointer rounded-r-xl">
              Add
            </button>
          </div>
          ...
          <button
            type="submit"
            className="py-0.5 mt-4 w-full bg-sky-300 hover:bg-sky-400 cursor-pointer duration-300 col-span-2 rounded-b-xl">
            Save New Product
          </button>
        </form>
      </div>
